...
public class WebUsuarioService {
    ...
    public Usuario cadastrar(UsuarioCadastroForm form) {
        ...
        if(!senha.equals(confirmacaoSenha)){
            var mensagem = "Os dois campos de senha nao conferem!";
        ...
        repository.findByEmail(form.getEmail()).ifPresent((usuario) -> {
            var mensagem = "Ja existe um usuario cadastrado com esse email!";
            var fieldError =  new FieldError(form.getClass().getName(), "email", form.getEmail(), false, null, null, mensagem);
